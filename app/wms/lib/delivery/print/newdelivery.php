 ...
 *
 * @author kami
 * @package ome_delivery_print_delivery
                ...
                if ($data) {
                    ...
                    foreach ($data['delivery_items'] as $k => $item) {
                        ...
                        if($item['order_source'] == 'tbdx' && $item['shop_type'] == 'taobao'){
                            ...
                            $ext_item_info = $dlyObj->db->selectrow($sql);
                            
                            $data['delivery_items'][$k]['price'] = $ext_item_info['price'];
                            $data['delivery_items'][$k]['amount'] = $ext_item_info['amount'];
