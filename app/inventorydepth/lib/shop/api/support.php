...
class inventorydepth_shop_api_support
{
    ...
    public static $item_sku_get_shops = array('taobao','paipai','360buy','bbc');
    /**
    ...
    public static $items_all_get_shops = array('taobao','paipai','360buy','bbc');
    /**
    ...
    public static $items_get_shops = array('taobao','paipai','360buy','bbc');
    /**
     * 接口store.item.get 
     *
     * @return void
