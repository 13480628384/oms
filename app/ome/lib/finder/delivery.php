...
class ome_finder_delivery{
    ...
    var $addon_cols = "skuNum,itemNum,bnsContent,delivery_id,status,process,stock_status,deliv_status,expre_status,verify,is_bind,type,bind_key,order_createtime,deli_cfg,is_cod,delivery_logi_number,logi_number,logi_no";
