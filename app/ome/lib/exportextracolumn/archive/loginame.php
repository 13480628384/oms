...
class ome_exportextracolumn_archive_loginame extends ome_exportextracolumn_abstract implements ome_exportextracolumn_interface{
    ...
    public function associatedData($ids){
        $sql = 'select ad.logi_name,aod.'.$this->__pkey.' from  sdb_archive_order_delivery as aod left join sdb_archive_delivery as ad on ad.delivery_id=aod.delivery_id where aod.order_id in ('.implode(',',$ids).')';
