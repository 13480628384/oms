...
class ome_mdl_operation_log extends dbeav_model{
    ...
    function __construct($app){
        ...
        foreach(kernel::servicelist('operation_log') as $k=>$v){
            if(method_exists($v,'get_operations')){
                $this->operations += $v->get_operations();
            }
        }
    }
     ...
     * @return bool
     */
    function batch_write_log($operation,$memo=NULL,$operate_time=NULL,$filter='',$opinfo=NULL){
