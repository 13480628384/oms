...
class ome_mdl_refund_apply extends dbeav_model{
    ...
    function _filter($filter,$tableAlias=null,$baseWhere=null){
        if(isset($filter['order_bn'])){
            ...
            $archives = $archive_ordObj->getOrder_list(array('order_bn|has'=>$filter['order_bn']),'order_id');
    ...
    function check_iscancel($order_id,$memo=null){
       ...
       {
           #部分发货订单_全额订单后撤消未发货的发货单 ExBOY
           $result_cancel    = $oOrder->cancel_delivery($order_id);
