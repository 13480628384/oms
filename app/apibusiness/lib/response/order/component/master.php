...
class apibusiness_response_order_component_master extends apibusiness_response_order_component_abstract
{
    ...
    public function convert()
    {
        ...
        #加入手动单拉订单_标记_防止自动审单 ExBOY
        $this->_platform->_newOrder['auto_combine']    = ((isset($this->_platform->_ordersdf['auto_combine']) && $this->_platform->_ordersdf['auto_combine'] === false) ? false : true); 
    }
    ...
    public function update()
    {
        ...
        if ($payment_list 
            ...
            && ($this->_platform->_tgOrder['pay_status'] == '0' || $this->_platform->_tgOrder['pay_status'] == '3' ||$this->_platform->_tgOrder['pay_status'] == '8')) {
