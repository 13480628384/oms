...
class openapi_data_original_delivery{
    ...
    public function getList($filter,$offset=0,$limit=100){
        ...
        if(intval($count['_c']) >0){
            ...
            $deliveryLists = $db->select("select d.shop_id,d.branch_id,d.member_id,d.delivery_bn,d.ship_name,d.ship_province,d.ship_city,d.ship_district,d.ship_addr,d.ship_zip,d.ship_tel,d.ship_mobile,d.ship_email,d.op_id,d.delivery_id,d.ship_tel,d.ship_email,d.logi_no,d.logi_name,d.delivery_cost_actual,d.delivery_time,d.create_time from sdb_ome_delivery as d  WHERE " . implode(' AND ', $where) ." order by d.create_time asc limit ".$offset.",".$limit."");
            ...
            $delivery_items = $db->select("select bn,number,product_name,delivery_id,item_id from sdb_ome_delivery_items where ".$_where_sql."");
