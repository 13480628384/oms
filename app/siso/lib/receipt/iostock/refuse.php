<?php
class siso_receipt_iostock_refuse extends siso_receipt_iostock_abstract implements siso_receipt_iostock_interface{
    /**
     *
     * 出入库类型id
     * @var int
    ...
    function get_io_data($data){
        ...
        $reship_items = $oReship_items->getlist('*',array('reship_id'=>$reship_id,'return_type'=>array('refuse'),'normal_num|than'=>0),0,-1);
