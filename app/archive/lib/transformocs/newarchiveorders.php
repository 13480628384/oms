...
{ 
    ...
    public function _getorderObject($order_ids)
    {
        ...
        $item_keys = 'order_id,obj_id,item_id,shop_goods_id,product_id,shop_product_id,bn,`name`,cost,price,amount,pmt_price,sale_price,nums,sendnum,item_type,score,sell_code,`delete`';
