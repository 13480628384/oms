...
class finance_cronjob_execQueue{
    ...
    */
    ...
    {  
        ...
        //do {
            $result = kernel::single('finance_rpc_request_bill')->setShopId($shop_id)->bills_get($start_time,$end_time,$page_no,$page_size,$time_type);
            ...
            if ($result['rsp'] == 'succ') {
                if ($data['bills']['bill']) {
                    $bills = array();
                    foreach ($data['bills']['bill'] as $value) {
    ...
    {  
        ...
        $result = kernel::single('finance_rpc_request_bill')->setShopId($shop_id)->sync_bills_book_get($account_id,$start_time,$end_time,null,$page_no,$page_size);
