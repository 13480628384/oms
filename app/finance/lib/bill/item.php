...
class finance_bill_item extends eccommon_analysis_abstract implements eccommon_analysis_interface{
    ...
    public function finder(){
        $this->export_href = 'index.php?app=omeio&ctl=admin_task&act=create_export&_params[app]=finance&_params[mdl]=bill&_params[time_from]='.$this->_params['time_from'].'&_params[time_to]='.$this->_params['time_to'].'&_params[fee_item_id]='.$this->_params['fee_item_id'].'&_params[fee_type_id]='.$this->_params['fee_type_id'];
        return array(
