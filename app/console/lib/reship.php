...
class console_reship{
    ...
    */
     ...
     */
    function change_freezeproduct($reship_id,$type='+',$branch_id=0)
    {
    ...
    function change_items($reship_id)
    {
        ...
        $reship_item = $oReship_item->getList('bn,product_name,num,product_id',array('reship_id'=>$reship_id,'return_type'=>'change'),0,-1);
        return $reship_item;
    }
}
?>