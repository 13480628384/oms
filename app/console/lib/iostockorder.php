        ...
        switch($type_id){
            ...
            case '11'://调拨入库取消 原仓库入库
                ...
                if ($stockinLib->create($params, $data, $msg)){
                    if( (isset($extend['po_type']) && $extend['po_type'] == 'credit') || in_array($type_id,array('70','800'))){
                        $io = '1';
            ...
            case '300'://样品出库
                ...
                $stockoutLib->_typeId = $type_id;
                if ($stockoutLib->create($params, $data, $msg)){
                    if(in_array($type_id,array('7','700'))){
                        $io='0';
