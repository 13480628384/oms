...
* 伊腾忠发起调用类
* 
* @copyright shopex.cn 2013.05.07
* @author dongqiujing<123517746@qq.com>
*/
class middleware_wms_ilcwms_request extends middleware_wms_requestInterface{

    public function __construct(){
        $this->_router = kernel::single('middleware_wms_ilcwms_router');
    }
    ...
    */
    public function stockin_create($sdf=array(),$sync=false){
        $class = 'middleware_wms_ilcwms_request_stockin';
    ...
    */
    public function stockout_create($sdf=array(),$sync=false){
        $class = 'middleware_wms_ilcwms_request_stockout';
    ...
    */
    public function delivery_create($sdf=array(),$sync=false){
        $class = 'middleware_wms_ilcwms_request_delivery';
    ...
    */
    public function reship_create($sdf=array(),$sync=false){
        $class = 'middleware_wms_ilcwms_request_reship';
    ...
    */
    public function goods_add($sdf=array(),$sync=false){
        $class = 'middleware_wms_ilcwms_request_goods';
