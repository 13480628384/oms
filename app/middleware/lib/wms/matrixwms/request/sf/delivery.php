...
*/
class middleware_wms_matrixwms_request_sf_delivery extends middleware_wms_matrixwms_request_delivery{
    ...
    protected function __getDelivery_create_params($sdf){
        ...
        $params = array(
            ...
            'receiver_state' => $this->_formate_receiver_citye($sdf['consignee']['province']),
            'receiver_country'=>'中国',
