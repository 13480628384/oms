...
*/
class middleware_wms_matrixwms_request_arvato_stockout extends middleware_wms_matrixwms_request_stockout{
    ...
    protected function _getStockout_create_params( $sdf , $cur_page )
    {
        $params = parent::_getStockout_create_params($sdf , $cur_page);
         $params['logical_code'] = $this->getWarehouse_code($sdf['branch_bn']);
         //$params['logical_code'] = 'EIMI';
        return $params;
    }
