...
class purchase_finder_supplier{
    ...
    function column_operator($row){
        ...
        $url='index.php?app=desktop&act=alertpages&goto='.urlencode('index.php?app=ome&ctl=admin_goods&p[0]='.$supplier_id);
        $button .= "&nbsp;&nbsp;&nbsp;<a class=\"lnk\" href=\"".$url."\" target='_blank'>查看商品</a>";
        //往来帐
