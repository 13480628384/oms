                    ...
                    if ($this->insertWaybillCode($waybill_code, $params)) {
                        ...
                        if ($waybill) {
                            $waybillExtned = array(
                                ...
                                'position_no' => '',
                                'package_wdjc' => $v['package_center_name'] ? $v['package_center_name'] : '',
                                'package_wd' => $v['package_center_code'] ? $v['package_center_code'] : '',
                                'json_packet' => '',
                                'package_id'=>$v['trade_order_info']['package_id'],
                                'print_config'=> $v['print_config'] ? $v['print_config']:'',
                            );
                            //保存电子面单扩展信息
